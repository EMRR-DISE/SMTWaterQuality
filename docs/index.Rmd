...
To convert between turbidity and secchi depth for the purpose of this document, we used data from an integrated dataset of discrete water quality (Bashevkin et al, 2013, secchi depth and turbidity collected concurrently) collected by IEP surveys from 2000-2022 for the South Delta (area shown in map above). Data is available on GitHub here: [discretewq](https://github.com/InteragencyEcologicalProgram/discretewq)
...
Secchi = exp(-0.31*log(Turbidity) +5.3)
